...
* Keep catalog loading and generation start behind the `HeadlessCatalogOperations` seam; do not re-split the same authority across parallel loader/generator wiring paths.
