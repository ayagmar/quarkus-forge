...
│         │                                                           │
│    IdeDetector (cross-platform IDE auto-detection)                  │
│         │                                                           │
│         ├── Open in IDE (auto-detected or QUARKUS_FORGE_IDE_COMMAND)│
...
....
     ...
     Post-Generation Menu
            ...
            ├── Open in <detected IDE>  (one entry per auto-detected IDE)
            ├── Open Terminal
            └── Quit
....
