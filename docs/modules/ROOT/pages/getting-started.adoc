...
This guide covers the shortest path from clone or download to a working Quarkus Forge setup.
For deployment and adoption considerations, see xref:reference/security.adoc[Security].
